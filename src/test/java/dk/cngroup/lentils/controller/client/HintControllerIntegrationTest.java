...
@Transactional
public class HintControllerIntegrationTest extends AbstractClientControllerTest {
    ...
    public void testTakeHintCorrectly() {
        ...
        final String returnValue = executeGetHint();
    ...
    public void testTakeHintAfterGameHasEnded() {
        ...
        String returnValue = executeGetHint();
